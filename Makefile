...
bootpack.bin: bootpack.o dsctbl.o fifo.o graphic.o hankaku.o int.o keyboard.o memory.o mouse.o nasmfunc.o sheet.o tsprintf.o 
	$(LD) -e hari_main -o bootpack.bin bootpack.o dsctbl.o fifo.o graphic.o hankaku.o int.o keyboard.o mouse.o memory.o nasmfunc.o sheet.o tsprintf.o 
