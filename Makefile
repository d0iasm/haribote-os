...
bootpack.bin: bootpack.o dsctbl.o graphic.o hankaku.o int.o nasmfunc.o tsprintf.o 
	$(LD) -e hari_main -o bootpack.bin bootpack.o dsctbl.o graphic.o hankaku.o int.o nasmfunc.o tsprintf.o 
